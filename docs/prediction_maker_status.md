...
- V13 timing-correct India-VIX external-risk gate: 1,022 VIX-direct / VIX-gated / VIX-agreement rules across 745 aligned sessions; **0** passed the 85% daily gate in both later splits. It remains research-only because the historical VIX source is third-party derived; see `reports/v13_india_vix_gate/report.md`.
